  ...
  if kTrig == 1 then
    ...
    while kCountX < giSize do
      ...
      while kCountY < giSize do
        ...
        gkGrainRate = round(gkDensity*3.0)
        gkAmp = 10 ; scale2 gkDensity, -10, -5, 0.0, 50.0

        ;duration from 0.1 to 2
        gkDur = 50  ; scale2 gkDensity, 3.0, 0.2, 0.0, 50
        gkFreq scale2 gkDensity, 50, 51, 0.0, 50
...
i "Grain" 0 [60*60*24*7] "giSoundfile1"
