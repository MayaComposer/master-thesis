...
vslider bounds(72, 64, 240, 180) channel("DelaySlider") range(0.0, 500.0, 0.0, 1, 0.01) text("Delay") textColour(0, 0, 0, 255) colour(0, 0, 0, 255) trackerColour(166, 95, 163, 255) valueTextBox(1) fontColour(0, 0, 0, 255)

vslider bounds(72, 256, 240, 180) channel("SpraySlider") range(0.0, 500.0, 0.0, 1, 0.01) text("Spray") textColour(0, 0, 0, 255) colour(0, 0, 0, 255) trackerColour(166, 95, 163, 255) valueTextBox(1) fontColour(0, 0, 0, 255)
...
; grain reverb
 instr 2
    ...
    gkSpray chnget "SpraySlider" ;Increases the delay time for individual grains by a random range from 0 to the value of the spray parameter. 0 - 500 ms
    ; grain clock
    ...
    kwavekey2 = semitone(-7)/kfildur1 
    kwavekey3 = semitone(7)/kfildur1 
    kwavekey4 = semitone(11)/kfildur1 
    awavfm = 0 
    ...
    gkDelaySlider = gkDelaySlider + random(0, gkSpray)
